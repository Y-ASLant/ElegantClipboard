...
- 增加结构化文件详情后再次构建 Release，当前 ZIP 的 SHA-256 为 `a6bc666b2c5bf34638f8218f70d6bef950455d52ea682f7bcf482272217c150c`，与 `.sha256` 相符。包内 exe 与 Release exe 的 SHA-256 均为 `201a6d073d7ea9ad8dba05092a83a0d5c266e16ff26ba4f68e93249cbf5cc980`，归档仅含 exe、许可证和运行说明；解压到 `target/qa/file-details-package-31c45a216ba04ad3b63f8d267f6eba4f/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。以上先前摘要只用于追溯，已不对应当前同名 ZIP。
