...
- 增加数据库整理与空间回收后再次构建 Release，当前 ZIP 的 SHA-256 为 `5b62e5945d550b1cced69dd9cd3b03c2f37b509c1ebe6cff925f19ece7624284`，与 `.sha256` 相符。包内 exe 与 Release exe 的 SHA-256 均为 `ec301475c98a4ef519dbfc31213e1bf90b5bbbe6de58269792ee174b52e0fd4c`，归档仅含 exe、许可证和运行说明；解压到 `target/qa/database-maintenance-package-6ebb910a1bfa408c82ea16e53e56c914/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。以上先前摘要只用于追溯，已不对应当前同名 ZIP。
