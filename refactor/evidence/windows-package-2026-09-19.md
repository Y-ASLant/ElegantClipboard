...
- 增加批量合并复制与受控粘贴后再次构建 Release，当前 ZIP 的 SHA-256 为 `6b882cf29d1559fb143e1263594aac18d40c5dd29bb48bc735b50f0d00736a50`，与 `.sha256` 相符。包内 exe 的哈希与 Release 构建一致，归档仅含 exe、许可证和运行说明；解压到 `target/qa/merge-package-final-eb79716880924d0baa8c7a983d38b870/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。以上先前摘要只用于追溯，已不对应当前同名 ZIP。
