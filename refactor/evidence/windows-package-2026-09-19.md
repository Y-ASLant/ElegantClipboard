...
- 增加全局清空历史与强确认后再次构建 Release，当前 ZIP 的 SHA-256 为 `fea58e3876a4b4ff7b893299d323ec81db8b22c81b6725bae127eb8250c89b27`，与 `.sha256` 相符。包内 exe 与 Release exe 的 SHA-256 均为 `f4b4b211052894b60e9a1cac9e7df847b6ae0fe821d0ceffacb7b72dbcf40b7f`，归档仅含 exe、许可证和运行说明；解压到 `target/qa/clear-all-history-final-package-84cd60f5735e440287c6d89ca5ad2d7a/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。以上先前摘要只用于追溯，已不对应当前同名 ZIP。
