...
- 增加数据占用统计与数据目录入口后生成的先前同名 ZIP 摘要为 `80d40f120ef51745d0b4b95b74ba14c65613cbedb5e669acd5a41e43ca10c0b7`；当时解压到 `target/qa/data-size-package-final-507c6fce7d1f41b498c7ef23a9fa7e0b/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。
- 增加结构化文件详情后生成的先前同名 ZIP 摘要为 `a6bc666b2c5bf34638f8218f70d6bef950455d52ea682f7bcf482272217c150c`；当时解压到 `target/qa/file-details-package-31c45a216ba04ad3b63f8d267f6eba4f/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。
- 增加数据库整理与空间回收后生成的先前同名 ZIP 摘要为 `5b62e5945d550b1cced69dd9cd3b03c2f37b509c1ebe6cff925f19ece7624284`；当时解压到 `target/qa/database-maintenance-package-6ebb910a1bfa408c82ea16e53e56c914/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。
- 增加全局清空历史与强确认后生成的先前 ZIP 摘要为 `fea58e3876a4b4ff7b893299d323ec81db8b22c81b6725bae127eb8250c89b27`；当时包内 exe 与 Release exe 的 SHA-256 均为 `f4b4b211052894b60e9a1cac9e7df847b6ae0fe821d0ceffacb7b72dbcf40b7f`，解压到 `target/qa/clear-all-history-final-package-84cd60f5735e440287c6d89ca5ad2d7a/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。
- 统一卡片与分组边缘滚动并支持静止指针持续排序后再次构建 Release，当前 ZIP 的 SHA-256 为 `2bfacb9fe9ed03b89c8b9984b7d7eebf6406a2a9921c464f9aef28d751e3584d`，与 `.sha256` 相符。包内 exe 与 Release exe 的 SHA-256 均为 `21986f301b61f35ef5efa8270f325b93906eaeb1ef5207a1ccb4ff337243f424`，归档仅含 exe、许可证和运行说明；解压到 `target/qa/package-extracted-30126e9bf2474164b0a2e12078e01a83/` 后以独立目录 `target/qa/package-smoke-bb52dba4372b47d392e8f6e837159db2/` 运行 `--smoke-test`，退出码为 0。以上先前摘要只用于追溯，已不对应当前同名 ZIP。
