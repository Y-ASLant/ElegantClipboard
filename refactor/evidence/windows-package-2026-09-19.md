...
- 增加文件与图片路径复制、受控粘贴和资源管理器定位后再次构建 Release，当前 ZIP 的 SHA-256 为 `9675251038fe388d3c08bb66a5bd8345b30ca7b8c04d4e7e791c854232178647`，与 `.sha256` 相符。包内 exe 与 Release exe 的 SHA-256 均为 `1695e81d1dea62831edab66eea8975e2874e3ee088ad7422544d5cba4c4d42c5`，归档仅含 exe、许可证和运行说明；解压到 `target/qa/file-actions-package-6087b94ed1824632a22a150f5775080a/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。以上先前摘要只用于追溯，已不对应当前同名 ZIP。
