...
- 增加文件与图片另存为后再次构建 Release，当前 ZIP 的 SHA-256 为 `3c866bba97e5a635737aac609b017ef9eb2602517c64e0c72e4397ccbb886def`，与 `.sha256` 相符。包内 exe 与 Release exe 的 SHA-256 均为 `81b5b0392e92ad61fe2397f7e9fe4484e37c8cafcc31854977ec7f189eae93d9`，归档仅含 exe、许可证和运行说明；解压到 `target/qa/save-as-package-26b4dedb3a144ea19a7f08d426960ce8/` 后以独立数据目录运行 `--smoke-test`，退出码为 0。以上先前摘要只用于追溯，已不对应当前同名 ZIP。
