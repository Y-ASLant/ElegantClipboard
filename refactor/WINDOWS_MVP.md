...
首批功能：文本采集、历史持久化、精确去重、搜索、复制、删除、置顶、暂停/恢复。全局快捷键、自动粘贴、图片/文件等后续开发。
...
- 关闭窗口后隐藏到系统托盘，左键托盘图标或右键菜单“打开剪贴板历史”可恢复；右键菜单“退出 ElegantClipboard”结束后台监听。托盘初始化失败会在状态栏提示，关闭窗口则正常退出。当前未提供全局快捷键或自动粘贴。
